 ...
 *
 * Gegenstück: {@link GraphAntwortException}.
 */
public class GraphUnbekanntException extends RuntimeException {

    public GraphUnbekanntException(String nachricht, Throwable ursache) {
