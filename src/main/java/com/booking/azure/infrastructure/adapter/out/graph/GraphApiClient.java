 ...
 *   Implementiert den ausgehenden Port {@link GraphApiRequest}.
 ...
 *
 * <ul>
 *   <li>{@link GraphResponseException} – Graph hat geantwortet und abgelehnt.
 *       Gewissheit: es wurde nichts geschrieben.</li>
 *   <li>{@link GraphUnknownException} – keine Antwort erhalten.
...
public class GraphApiClient implements GraphApiRequest {
    ...
    private <T> T ausfuehren(String methode, String url, Supplier<T> aufruf) {
        try {
            ...
            throw new GraphResponseException(ex.getStatusCode().value(),
        ...
        } catch (GraphUnknownException ex) {
            throw ex;
